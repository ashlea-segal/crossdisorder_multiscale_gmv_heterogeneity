...
maindir = '/scratch/kg98/Ashlea/lesion_networks/data/Level3_Analysis/meants_indivDeviations_union_spinTests/rfMRI_REST1_LR/withSubcortical/';
...
for p=1:length(parcel_thresholds)
    ...
    file_string = ['_tfce_tstat_cfwep_c1_thr_parc',parcel_thr,'_bin_TRANSPOSE_union_Nspin10000'];
    ...
    for d=1:2
        ...
        for g=1:length(groups)
            ...
            wdir = [maindir,'/parc',parcel_thr,'/',direction,'/',group,'/'];
            cd(wdir)
